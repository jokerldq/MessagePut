            ...
            <div class="navbar-inner">
                <div class="container-fluid">
                    <a class="brand" href="http://www.papaok.org"><i
                            class="icon-home icon-white"></i> 浪噔呛的树洞 <span class="sml_t">2.0</span></a>
                    ...
                    <ul class="nav user_menu pull-right">
                        ...
                        <#if user??>
                            <img src="user?action=pic&id=${user.userid}" alt="用户:" class="user_avatar" />
                            ${user.username}
                        <#else>
                            ...
                            <#if user??>
                                <li><a href="#post" title="发布信息" data-toggle="modal"
                                       id="myp" data-backdrop="static"
                                       onclick="javascript:addz();document.getElementById('submenu').innerHTML='发布信息'">发布信息</a>
    ...
    */
    function showhuitie(id,uid,duid,data){
        ...
        $(data.list).each(function(i){
            ...
            console.log(uid+":"+data.list[i].user.userid+":duid:"+duid);

            if(uid===duid||uid===data.list[i].user.userid){//字符串是否相等,删除从贴
